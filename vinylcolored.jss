...
body {
    background-image: url('./images/backgrounds/vinyl.jpg');
...
#logo a {
    ...
    width: auto;
    height: 80px;
    background: url('./images/light-on-dark/logo.png') no-repeat top left;
...
#userinfo_minor {
    ...
    background: url('./images/caret-light.png') center center no-repeat #FC2E62;
